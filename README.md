...
**Main dashboard** — project sidebar, session cards grouped by date, transcript viewer:

![Main dashboard](screenshots/dashboard-main.png)

**Transcript view** — tool calls and diffs expanded:

![Transcript view](screenshots/dashboard-transcript.png)

**Cleanup & trash panel** — builds the exact CLI command for bulk delete/restore/retention:
